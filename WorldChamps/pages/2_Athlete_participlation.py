...
df_num_attend_female_boulder = pd.read_csv('WorldChamps/report_files/Number_of_Boulder_World_Champs_attended_female.csv')
df_num_attend_male_boulder = pd.read_csv('WorldChamps/report_files/Number_of_Boulder_World_Champs_attended_male.csv')
df_num_attend_female_lead = pd.read_csv('WorldChamps/report_files/Number_of_Lead_World_Champs_attended_female.csv')
df_num_attend_male_lead = pd.read_csv('WorldChamps/report_files/Number_of_Lead_World_Champs_attended_male.csv')
df_num_attend_female_speed = pd.read_csv('WorldChamps/report_files/Number_of_Speed_World_Champs_attended_female.csv')
df_num_attend_male_speed = pd.read_csv('WorldChamps/report_files/Number_of_Speed_World_Champs_attended_male.csv')
df_num_attend_female_combined = pd.read_csv('WorldChamps/report_files/Number_of_Combined_World_Champs_attended_female.csv')
df_num_attend_male_combined = pd.read_csv('WorldChamps/report_files/Number_of_Combined_World_Champs_attended_male.csv')
df_num_attend_female_boulderlead = pd.read_csv('WorldChamps/report_files/Number_of_BoulderLead_World_Champs_attended_female.csv')
df_num_attend_male_boulderlead = pd.read_csv('WorldChamps/report_files/Number_of_BoulderLead_World_Champs_attended_male.csv')
df_num_attend_female_all_disciplines = pd.read_csv('WorldChamps/report_files/Number_of_World_Champs_all_disciplines_attended_female.csv')
df_num_attend_male_all_disciplines = pd.read_csv('WorldChamps/report_files/Number_of_World_Champs_all_disciplines_attended_male.csv')
...
df_num_attend_female_boulderlead.index = df_num_attend_female_boulderlead.index + 1
df_num_attend_male_boulderlead.index = df_num_attend_male_boulderlead.index + 1
