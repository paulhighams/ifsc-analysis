...
st.set_page_config(
    page_title="Speed Relay Athlete Statistics",
    page_icon="👋",
	layout="wide",
)

st.header ("Speed Relay Athlete Statistics")

tab1, tab2, tab3, tab4, tab5 = st.tabs (["Female alltime","Male alltime","Tree Map","Last 3 years World cups and Championships Podiums","Speed Relay Records"])
