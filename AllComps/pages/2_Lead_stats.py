...
df_Female_athlete_stats = pd.read_csv('AllComps/report_files/athlete_stats_lead_female.csv')
df_Male_athlete_stats = pd.read_csv('AllComps/report_files/athlete_stats_lead_male.csv')
df_wins_by_athlete_by_country = pd.read_csv('AllComps/report_files/lead_wins_by_athlete_by_country.csv')
df_last_3_years_world_cups = pd.read_csv('AllComps/report_files/last_3_years_world_cups_lead.csv') 
df_last_3_years_world_champs = pd.read_csv('AllComps/report_files/last_3_years_world_champs_lead.csv') 
...
st.set_page_config(
    page_title="Lead Athlete Statistics",
    page_icon="👋",
	layout="wide",
)

st.header ("Lead Athlete Statistics")
